...
export default async function EditProjectPage({ params }: PageProps) {
  ...
  const defaultValues: ProjectFormValues = {
    ...
    contractDate: project.contractDate ? formatDateInput(project.contractDate) : "",
    designDocVersion: project.designDocVersion ?? "",
    designDocDate: project.designDocDate ? formatDateInput(project.designDocDate) : "",
